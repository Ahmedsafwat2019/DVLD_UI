    ...
    <section className="relative min-h-[calc(100vh-5rem)] bg-white">
      <div className="min-h-[calc(100vh-5rem)] flex justify-center items-center">
        <div className="flex flex-col items-center justify-center space-y-6 px-8 text-right lg:px-16">
          <h1 className="text-3xl sm:text-5xl  lg:text-6xl  font-bold text-center leading-tight tracking-tight mb-10">
            مرحبا بكم فى الموقع الرسمى
            <br />
            لبوابة مرور مصر
          </h1>
          <section className="flex flex-col gap-6 w-full justify-center items-center">
            <p className="max-w-xl text-xl sm:text-2xl lg:text-3xl text-center text-muted-foreground ">
